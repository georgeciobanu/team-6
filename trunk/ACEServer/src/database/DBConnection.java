...
public class DBConnection {
    ...
    public int addMarketOrder(sMarketOrder order) {
        ...
        */
        ...
        // Get market price
    public int getUserID2(String username, String password) {
        if (username.length() > 0 && password.length() > 0) {
            try{
                String queryString =
                        "SELECT userid " +
        ...
        public float getMarketPrice2(int buysell, String currencyPair) {
            try {
                return 0;
                /*
                System.out.println("buysell=" + buysell);
                System.out.println("currencyPair=" + currencyPair);
                String queryString;
                if(buysell == 1) {
                    queryString =
                            "SELECT price " +
                            "FROM orderpool " +
                            "WHERE orderstatus='1' " + //orderstatus=1 ==> pending order
                            "AND type='1' " +  //type=1 ==> marketorder
